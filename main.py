...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval", "-e", type=str, nargs='+', default=["data/twitter_test.ner"], help="evaluation files")
    parser.add_argument("--outdir", "-o", type=str, default=".", help="location of evaluation files")
    # change default tagger here
    parser.add_argument("--tagger", "-T", default="crf", choices=["logreg", "crf"], help="which tagger to use; change the default to the one you want to use on q 3.2")
